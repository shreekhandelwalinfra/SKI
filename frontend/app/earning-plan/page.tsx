...
export const metadata: Metadata = {
    title: 'Earning Plan – Shree Khandelwal Infra',
    description: 'Understand the SKI earning plan — a transparent rank-based system where you earn commissions and unlock rewards through real estate investments and team building.',
};
                            ...
                            <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '680px', fontFamily: 'var(--font-inter), sans-serif' }}>
                                ...
                                <tbody>
                                    {ranks.map((r, i) => {
                                        ...
                                        return (
                                            <tr key={r.rank} style={{ background: i % 2 === 0 ? 'var(--bg-surface)' : 'var(--bg-primary)', borderBottom: '1px solid var(--border-subtle)' }}>
                                                ...
                                                <td style={{ padding: '12px 16px', textAlign: 'center', fontWeight: 500, color: 'var(--text-primary)', fontSize: '0.84rem' }}>{r.teamBusiness}</td>
                                                <td style={{ padding: '12px 16px', textAlign: 'center' }}>
