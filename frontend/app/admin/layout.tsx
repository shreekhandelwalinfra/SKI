...
import { getAdminNotifications, markAdminNotificationsRead, markAdminNotificationRead } from './lib/api';
                        ...
                        <header style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.9rem 1.5rem' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                                    <NotificationBell
                                        fetchNotifications={getAdminNotifications}
                                        markAllRead={markAdminNotificationsRead}
                                        markOneRead={markAdminNotificationRead}
                                        socketEvent="admin_notification:new"
                                    />
                                    {/* Avatar */}
                                    <div style={{
