...
// Geometric SKI Logo for Footer
function SKILogoSmall() {
    return (
        <img src="/logo.png" alt="SKI Logo" style={{ width: '48px', height: '48px', objectFit: 'contain' }} />
    );
}
        ...
        >
            <div className="container-max px-6 py-4">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    {/* Center — Copyright */}
                    <p className="text-[11px] opacity-60 tracking-wide">
                        All Shree Khandelwal Infra rights reserved.
                    </p>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {/* Another Twitter / X icon for the reference look */}
